...
<style scoped>
  .errorPage{ width: 100%; height: 100%; min-height: 500px; background-color: #fff; text-align: center; padding-top: 100px; }
  ...
  .errorPage .textInfo h1{ font-size: 60px; color:#f89b38; font-weight: bold; margin-bottom: 40px; }
